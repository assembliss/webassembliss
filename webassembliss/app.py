...
def grader_results():
    sample_data = r"""{"submission": {"timestamp": "2025-02-20T04:17:24.592248+00:00", "name": "Hello", "ID": "Bye", "files": {"hello.S": ".data\r\n\r\n/* Data segment: define our message string and calculate its length. */\r\nmsg:\r\n    .ascii        \"Hello folks!\\n\"\r\nlen = . - msg\r\n\r\n.text\r\n\r\n/* Our application's entry point. */\r\n.global _start\r\n_start:\r\n    /* syscall write(int fd, const void *buf, size_t count) */\r\n    mov     x0, #1      /* fd := STDOUT_FILENO */\r\n    ldr     x1, =msg    /* buf := msg */\r\n    ldr     x2, =len    /* count := len */\r\n    mov     w8, #64     /* write is syscall #64 */\r\n    svc     #0          /* invoke syscall */\r\n\r\n    /* syscall exit(int status) */\r\n    mov     x0, #0      /* status := 0 */\r\n    mov     w8, #93     /* exit is syscall #93 */\r\n    svc     #0          /* invoke syscall */\r\n"}, "project_name": "Hello Project Config", "project_checksum64": "qAQDWDtNKb/AgX7TVwOO78cFt/7A2GSiOr/wjDKgT+Q=\n", "line_count": 8, "pct_comment_only_lines": 50.0, "agg_exec_count": 24, "received_test_points": 10, "max_test_points": 15, "total": 0.0, "checksum64": "qUNwmXaPUBrA3/W7BGeWfOdNVsRNRNsJcd7S272nJzc=\n"}, "must_pass_all_tests": true, "assembled": true, "linked": true, "errors": "", "scores": {"accuracy": 0.0, "documentation": 0.0, "source_efficiency": 0.0, "exec_efficiency": 0.0}, "weights": {"source_efficiency": 0.16666666666666666, "documentation": 0.16666666666666666, "accuracy": 0.5, "exec_efficiency": 0.16666666666666666}, "tests": [{"name": "Passing test", "points": 5, "executed": true, "timed_out": false, "passed": true, "hidden": false, "exit_code": 0, "cl_args": [], "stdin": "input1", "expected_out": "Hello folks!\n", "actual_out": "Hello folks!\n", "actual_err": ""}, {"name": "Passing test with bytes", "points": 5, "executed": true, "timed_out": false, "passed": true, "hidden": false, "exit_code": 0, "cl_args": [], "stdin": [105, 110, 112, 117, 116, 50], "expected_out": [72, 101, 108, 108, 111, 32, 102, 111, 108, 107, 115, 33, 10], "actual_out": [72, 101, 108, 108, 111, 32, 102, 111, 108, 107, 115, 33, 10], "actual_err": ""}, {"name": "Failing test", "points": 2, "executed": true, "timed_out": false, "passed": false, "hidden": false, "exit_code": 0, "cl_args": [], "stdin": "input3", "expected_out": "Wrong output", "actual_out": "Hello folks!\n", "actual_err": ""}, {"name": "Another failing test", "points": 2, "executed": false, "timed_out": false, "passed": false, "hidden": false, "exit_code": null, "cl_args": ["arg1", "arg2"], "stdin": "input4", "expected_out": "I did not run...", "actual_out": "", "actual_err": ""}, {"name": "Yet another failing test", "points": 1, "executed": false, "timed_out": false, "passed": false, "hidden": true, "exit_code": null, "cl_args": [], "stdin": "", "expected_out": "", "actual_out": "", "actual_err": ""}], "docs_points": [["x >= 50", 1.0], ["50 > x >= 40", 0.75], ["40 > x >= 30", 0.5], ["30 > x", 0.0]], "source_points": [["x <= 8", 1.0], ["8 < x <= 10", 0.95], ["10 < x <= 20", 0.8], ["20 < x", 0.0]], "exec_points": [["x <= 10", 1.0], ["10 < x <= 15", 0.95], ["15 < x", 0.0]], "exec_agg_method": "SUM"}"""
    gr = GraderResults.from_json(sample_data)
    return render_template("grader_results.html.j2", results=gr)
